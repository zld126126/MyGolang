...
func init() {
	...
	var err error
	client, err = elastic.NewClient(elastic.SetHealthcheck(false), elastic.SetErrorLog(errorlog), elastic.SetURL(host), elastic.SetSniff(false))
	if err != nil {
		panic(err)
	}
...
func search() {
	...
	if searchResult.Hits == nil {
		print("expected SearchResult.Hits != nil; got nil")
		return
	}
