...
func (p *JWTHdl) GetTokenName(c *gin.Context) {
...
func (p *JWTHdl) Login(c *gin.Context) {
...
func (p *JWTHdl) Refresh(c *gin.Context) {
	strToken := c.Param("token")
...
func (p *JWTHdl) verifyAction(strToken string) (*JWTClaims, error) {
