...
type TrackSourceType int32 // 埋点来源类型

const (
	TrackSourceType_Unknown       TrackSourceType = iota // 未知
	TrackSourceType_WxMiniProgram                        // 微信小程序
	TrackSourceType_Andriod                              // 安卓
	TrackSourceType_IOS                                  // IOS
)
...
type Track struct {
	...
	SourceTp   TrackSourceType `gorm:"default:0" json:"source_tp"`   // 来源类型
